  ...
  <main class="container mt-4">  
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">  
      <div>  
        ...
        <strong><?php echo $_SESSION['usuario_nombre'] . ' ' . $_SESSION['usuario_apellido']; ?></strong>  
        <span class="badge bg-danger ms-2"><?php echo $_SESSION['usuario_rol']; ?></span>  
      </div>  
      <a href="CRUD/cerrarSesion.php" class="btn btn-outline-danger btn-sm">  
