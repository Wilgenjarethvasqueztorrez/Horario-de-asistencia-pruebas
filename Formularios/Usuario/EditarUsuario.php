...
<body>
    ...
    <form class="container" action="../../CRUD/Usuario/editarUsuario.php" method="post">
        ...
        <div class="mb-3">
            ...
            <input type="email" class="form-control" name="CorreoUsuario" value="<?php echo $row['correo']; ?>"
                required>
        </div>
        ...
        <select class="form-select mb-3" name="RolSistema" required>
            ...
            <option value="Administrador" <?php echo ($row['rol_sistema'] == 'Administrador') ? 'selected' : ''; ?>>
                Administrador</option>
            <option value="Oficina" <?php echo ($row['rol_sistema'] == 'Oficina') ? 'selected' : ''; ?>>Oficina</option>
            <option value="Empleado" <?php echo ($row['rol_sistema'] == 'Empleado') ? 'selected' : ''; ?>>Empleado
            </option>
        </select>
