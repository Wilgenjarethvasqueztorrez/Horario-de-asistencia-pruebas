...
<body>
    ...
    <main class="container mt-4" id="contenido-pdf">
        ...
        <div class="alert alert-info">
            ...
            <?php echo $empleado['activo'] ? '<span class="badge bg-success">Activo</span>' : '<span class="badge bg-secondary">Inactivo</span>'; ?>
        </div>
            ...
            <table class="table table-hover">
                ...
                <tfoot>
                    <tr class="table-info">
                        ...
                        <td colspan="2"><strong><?php echo number_format($total_horas_acumuladas, 2); ?> hrs</strong>
                        </td>
                    </tr>
                </tfoot>
            </table>
