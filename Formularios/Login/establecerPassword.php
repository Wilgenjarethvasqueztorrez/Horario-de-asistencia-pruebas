...
<body class="establecer-password-page">  
    <div class="container">  
        <div class="row justify-content-center align-items-center" style="min-height: 100vh;">  
            <div class="col-12 ep-login-page">  
                <div class="card shadow ep-login-card">  
                    <div class="card-body p-5">  
                        <div class="ep-brand-logo">
                            <img src="../../src/images/logo-uml.png" alt="Logo UML">
                        </div>
                        <h2 class="text-center ep-page-title mb-2">  
                            <i class="bi bi-key"></i> Establecer Contraseña  
                        </h2>  
                        <p class="text-center ep-page-subtitle">Crea tu nueva contraseña para acceder al portal de la Universidad Martín Lutero.</p>  
                          
                        <div class="alert alert-ep-custom" role="alert">  
