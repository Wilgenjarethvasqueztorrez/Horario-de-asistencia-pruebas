...
<body>
    ...
    <form class="container" action="../../CRUD/Horario/editarHorario.php" method="post">
        ...
        <div class="mb-3" id="horaInicioDiv"
            style="display:<?php echo ($row['tipo'] == 'Fijo') ? 'block' : 'none'; ?>;">
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control" name="HorasMinimas" step="0.5" min="0" max="24"
                value="<?php echo $row['horas_minimas']; ?>" required>
        </div>
