            ...
            <div class="col-md-8">
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <label class="text-muted-perfil small">Nombre Completo</label>
                                <p class="fw-bold mb-0"><?php echo $usuario['nombre'] . ' ' . $usuario['apellido']; ?>
                                </p>
                            </div>
                            <div class="col-md-6">
                                <label class="text-muted-perfil small">Correo Electrónico</label>
                                <p class="mb-0">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <label class="text-muted-perfil small">Rol del Sistema</label>
                                <p class="mb-0">
                                    <?php
                                    $badge_class = '';
                                    $icon = '';
                            ...
                            <div class="col-md-6">
                                <label class="text-muted-perfil small">Fecha de Hoy</label>
                                <p class="mb-0">
                        ...
                        <div class="alert alert-info mb-0">
                            ...
                            <strong>Permisos:</strong> Como <?php echo $usuario['rol_sistema']; ?>, tienes
                            <?php
                            echo $usuario['rol_sistema'] === "Administrador"
                                ? "acceso completo a la gestión del sistema."
                                : ($usuario['rol_sistema'] === "Oficina"
                                    ? "acceso limitado a ciertas funciones de la gestion del sistema."
                                    : "acceso restringido.");
                            ?>
                ...
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        <ul class="list-unstyled mb-0">
                            ...
                            <li class="mb-2">
                                <i class="bi bi-shield-check text-primary"></i> Acceso de nivel:
                                <?php echo $usuario['rol_sistema']; ?>
                            </li>
                            <li class="mb-2">
                                <i class="bi bi-clock-history text-info"></i> Última sesión:
